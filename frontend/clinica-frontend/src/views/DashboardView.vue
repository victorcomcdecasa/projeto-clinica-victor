...
const fazerAgendamento = async () => {
  try {
    ...
    await axios.post('https://https://proviclinicafe.onrender.com/api/services/agendar', {
...
const buscarAgendamentos = async () => {
  try {
    const token = localStorage.getItem('token');
    const res = await axios.get('https://https://proviclinicafe.onrender.com/api/services/meus-agendamentos', {
...
onMounted(async () => {
  ...
  try {
    const res = await axios.get(`https://proviclinicafe.onrender.com/api/services/clima/${cidade.value}`);
